    ...
    <div class="accordion" id="faqAccordion">
      ...
      <div class="accordion-item">
        ...
        <div id="faq1" class="accordion-collapse collapse show" aria-labelledby="faq1-heading" data-bs-parent="#faqAccordion">
          <div class="accordion-body">
            USTRUCKPATH is an online learning platform that helps people from around the world become licensed truck drivers in the <strong>USA and Canada</strong>. We provide step-by-step courses, expert mentorship, and daily support.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div id="faq2" class="accordion-collapse collapse" aria-labelledby="faq2-heading" data-bs-parent="#faqAccordion">
          <div class="accordion-body">
            Anyone interested in a trucking career in North America can join — whether you live in the USA, Canada, or abroad. Our course is designed for both local and international students.
          </div>
        </div>
      </div>
        ...
        <div id="faq3" class="accordion-collapse collapse" aria-labelledby="faq3-heading" data-bs-parent="#faqAccordion">
          <div class="accordion-body">
            <ul>
              ...
              <li>Cross-border driving rules</li>
              <li>Real-world tips from experienced drivers</li>
              <li>Private Telegram group with daily Q&A and mentorship</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div id="faq4" class="accordion-collapse collapse" aria-labelledby="faq4-heading" data-bs-parent="#faqAccordion">
          <div class="accordion-body">
            The full program is <strong>normally $497</strong>, but we are offering it now for a <strong>one-time payment of just $160</strong>. No monthly fees or subscriptions.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item">
        ...
        <div id="faq5" class="accordion-collapse collapse" aria-labelledby="faq5-heading" data-bs-parent="#faqAccordion">
          <div class="accordion-body">
            No! We offer support in multiple languages, and we’re adding more to help students from different countries feel confident and prepared.
          </div>
        </div>
      </div>
