        ...
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    ...
                    <li><a href="{{ route('front.course.category', 'cdl-canada') }}"
                           class="{{ request()->is('category/cdl-canada') ? 'active' : '' }}">CDL Canada</a></li>
                    <li><a href="{{ route('front.course.category', 'cdl-europe') }}"
                           class="{{ request()->is('category/cdl-europe') ? 'active' : '' }}">CDL Europe</a></li>
                    <li><a href="{{ route('front.course.category', 'cdl-global') }}"
                           class="{{ request()->is('category/cdl-global') ? 'active' : '' }}">CDL Permit (Global)</a></li>
