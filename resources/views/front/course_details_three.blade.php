                        ...
                        @else
                            ...
                            @else
                                @if ($course->status === 'upcoming')
                                    <button class="btn btn-secondary btn-lg" disabled>Up Coming</button>
                                @elseif(auth()->user()->hasPurchasedCourse($course->id))
                                    <button class="btn btn-info btn-lg w-100" disabled>Request Pending...</button>
                                @else
                                    <!--<a href="{{ route('front.courses.enrollForm', $course->id) }}"-->
                                    <!--    class="btn btn-primary btn-lg">Enroll Now</a>-->
                        ...
                        <div class="row g-4  align-items-center">
                            <div class="col-md-6 p-4 d-flex flex-column justify-content-between about-back">
                                <div >
                                    ...
                                    <h2 class="card-title mb-3 fw-bold text-success"  >About This Course
                                    </h2>
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="text-muted small">Access video classes, eBooks, and audio lessons for a rich and engaging learning experience tailored to different learning styles.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-slide card border-0 shadow-sm rounded-4 p-4 h-100">
                                ...
                                <p class="text-muted mb-3">"I’m originally from Honduras and live in Columbus, Ohio. I had tried a couple of other programs to pass my CDL permit test, but they didn’t work for me. Then I found PassYourPermit.com, and it changed everything! The questions were just like the real test, and the lessons were easy to understand. I passed my permit test on the first try and joined CDL City Truck Driving School here in Columbus. Now I have my CDL, and I couldn’t be happier!"</p>
                                <div class="rating text-warning">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-slide card border-0 shadow-sm rounded-4 p-4 h-100">
                                ...
                                <p class="text-muted mb-3">"I’m originally from Egypt and lived in Dearborn, Michigan, working as a DoorDash delivery driver. I was tired of the long hours and low pay and wanted a better career. That’s when I found PassYourPermit.com and bought the Arabic version of the guide. It was perfect for me! The questions were just like the real test, and the lessons were so easy to follow in my own language. I passed my CDL permit test on the first try and joined CDL City Truck Driving School. Now I have my CDL and a new career I’m proud of. Thank you, PassYourPermit!"
                                </p>
                                <div class="rating text-warning">
                                    <i class="bi bi-star-fill"></i>
                                    <i class="bi bi-star-fill"></i>
