            ...
            <div class="max-w-5xl mx-auto bg-gray-50 rounded-2xl p-8">
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mb-4">Get ready to pass your CDL exams worldwide with this all-in-one study program. Whether you're preparing in the United States, Canada, Europe, or internationally, you'll have access to video lessons, audiobooks, and eBooks designed to fit your study style and pace.</p>
                        <p class="text-gray-600 mb-4">This course covers General Knowledge, Air Brakes, Combination Vehicles, Doubles/Triples, Hazmat / Dangerous Goods, Tanker, Passenger, and School Bus endorsements, along with real exam-style practice questions and answers.</p>
                        <p class="text-gray-600 mb-4">Content is updated regularly to reflect global CDL standards and regional requirements.</p>
                        <p class="text-gray-600 mb-6">Accessible on phone, tablet, or computer, with lifetime access for a one-time payment. No matter where you are in the world, CDL Global makes it simple, flexible, and effective to study and pass with confidence. Start today and become a licensed driver anywhere!</p>
            ...
            <div class="max-w-6xl mx-auto">
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-lg leading-relaxed mb-6">You don't need trucking experience. If you're over 21 and speak basic English, this course shows you how to move to the USA or Canada and start your driving career. We'll handle everything - from training guidance to helping you find a company that hires international drivers. Lifetime mentorship and daily support included through our private Telegram group.</p>
                        @guest
    ...
    <section class="py-16 bg-[#0A2342] text-white">
        <div class="container mx-auto px-4 text-center">
            <div class="max-w-3xl mx-auto">
                <h2 class="font-heading text-3xl font-bold text-[#F5B82E] uppercase mb-4">Ready to start your trucking career anywhere in the world?</h2>
                <p class="text-gray-300 text-lg mb-6">Join today - learn how to become a licensed commercial driver with lifetime mentorship and step-by-step support.</p>
                <p class="text-gray-300 mb-8">Enroll now and start your journey to becoming a professional truck driver!</p>
                @guest
