        ...
        <section class="relative min-h-[400px] flex items-center" style="background-image: url('{{ asset('frontend/img/whitetruck.jpg') }}'); background-size: cover; background-position: center 80%;">
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="max-w-4xl">
                    ...
                    <p class="text-xl text-white/90 mb-6">Unlock your trucking career with our full CDL permit prep course - available in English, with video, audio, and eBook lessons.</p>
        ...
        <section class="relative min-h-[500px] flex items-center" style="background-image: url('{{ asset('frontend/img/whitetruck.jpg') }}'); background-size: cover; background-position: center 80%;">
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                        <h1 class="font-heading text-4xl md:text-5xl font-bold text-gold mb-4">{{ $course->title }}</h1>
                        <p class="text-xl text-white/90 mb-6">{{ $course->short_description ?? 'Unlock your trucking career with our full CDL permit prep course - available in English, with video, audio, and eBook lessons.' }}</p>
                        <nav class="flex items-center space-x-2 text-sm">
                            <a href="{{ url('/') }}" class="text-white hover:text-gold transition-colors">Home</a>
                            <i data-lucide="chevron-right" class="w-4 h-4 text-white/60"></i>
                            <span class="text-gold">{{ $course->title }}</span>
        ...
        <section class="py-16 bg-white">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">We make it easy to pass your Commercial Learner's Permit (CLP) test. Our all-in-one course includes video lessons, audio guides, and an eBook - available in multiple languages. It's everything you need to get started in trucking.</p>
