                    ...
                    <div class="col-lg-8 text-center">
                        ...
                        <div class="section-title">
                            ...
                            <p class="lead text-muted">Your Fast-Track to a Truck Driving Career Starts Here
                                ...
                                We empower future truck drivers with an easy, effective, and guaranteed way to pass
                    ...
                    <div class="col">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            ...
                            <div class="card-body text-center p-4">
                                ...
                                <p class="text-muted small">Access video classes, eBooks, and audio lessons for a
            ...
            <div class="container">
                ...
                <div class="row justify-content-center mb-5">
                    ...
                    <div class=" ">
                        ...
                        <p class="text-muted text-center mb-0 mt-2" style="font-weight: 700; font-size:2rem; ">
                        ...
                        <ul class="list-group list-group-numbered">
                            ...
                            <li class="list-group-item d-flex   align-items-start">
                                ...
                                <div class="ms-2">
                                    ...
                                    <p>Video course, Audio course, Downloadable eBook, Covers all topics: General
                                        ...
                                        Air Brakes, Combination, Hazmat (H), Tanker (N), Doubles & Triples (T),
                            ...
                            <li class="list-group-item d-flex   align-items-start">
                                ...
                                <div class="ms-2">
                                    ...
                                    <p class="text-muted mb-0">This is your first step to becoming a CDL driver.
                ...
                <div class="row justify-content-center mb-1">
                    ...
                    <div class="col-lg-8 text-center">
                        ...
                        <div class="section-title">
                            ...
                            <p class="lead text-muted">Read inspiring stories from individuals who have
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="testimonial-slide card border-0 shadow-sm rounded-4 p-4 h-100">
                                ...
                                <p class="text-muted mb-3">"I’m so glad I found PassYourPermit.com! The practice

                                    questions

                                    were just like the real test and gave me the confidence I needed. I passed my

                                    permit

                                    test on the first try and even joined their trucking school, CDL City Truck
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="testimonial-slide card border-0 shadow-sm rounded-4 p-4 h-100">
                                ...
                                <p class="text-muted mb-3">"I’m originally from Honduras and live in Columbus,
                                    ...
                                    the first try and joined CDL City Truck Driving School here in Columbus. Now I
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="testimonial-slide card border-0 shadow-sm rounded-4 p-4 h-100">
                                ...
                                <p class="text-muted mb-3">"I’m originally from Egypt and lived in Dearborn,
                                    ...
                                    working as a DoorDash delivery driver. I was tired of the long hours and low pay

                                    and

                                    wanted a better career. That’s when I found PassYourPermit.com and bought the
                                    ...
                                    and the lessons were so easy to follow in my own language. I passed my CDL

                                    permit test

                                    on the first try and joined CDL City Truck Driving School. Now I have my CDL and
