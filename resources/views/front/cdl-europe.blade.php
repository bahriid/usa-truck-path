            ...
            <div class="max-w-5xl mx-auto bg-gray-50 rounded-2xl p-8">
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mb-4">Get ready to pass your European CDL / Driver CPC exams with this complete study program. Learn with video lessons, audiobooks, and eBooks, all designed to help you study at your own pace.</p>
                        <p class="text-gray-600 mb-4">This course includes Driver CPC theory test coverage, hazard perception training, case studies, and specialist modules such as Passenger Transport and Freight Transport.</p>
                        <p class="text-gray-600 mb-4">You'll also get real exam-style practice questions and answers, updated regularly to meet EU and UK standards.</p>
                        <p class="text-gray-600 mb-6">Accessible on phone, tablet, or computer, with lifetime access for a one-time payment. Study anywhere, anytime, and pass with confidence. Start today and drive your career forward!</p>
    ...
    <section class="py-16 bg-[#0A2342] text-white">
        <div class="container mx-auto px-4 text-center">
            <div class="max-w-3xl mx-auto">
                <h2 class="font-heading text-3xl font-bold text-[#F5B82E] uppercase mb-4">Ready to start your trucking career in North America?</h2>
                <p class="text-gray-300 text-lg mb-6">Join today - learn how to transition from Europe to the North American trucking industry with lifetime mentorship and step-by-step support.</p>
                <p class="text-gray-300 mb-8">Enroll now and let us help you start your new career!</p>
                @guest
