            ...
            <div class="max-w-5xl mx-auto bg-gray-50 rounded-2xl p-8">
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mb-4">The trucking industry runs on brokers and dispatchers - and thousands of people worldwide are building six-figure incomes in this field without owning a truck. This course and mentorship program teaches you both sides of the business - how to dispatch loads for drivers and how to broker freight between shippers and carriers.</p>
                        <p class="text-gray-600 mb-4">You can do this from anywhere - at home, in the USA, or overseas. Many successful dispatchers and brokers are based outside the U.S., working remotely with American trucking companies. We'll show you how to get started, what tools you need, and how to build your own brand or land clients who pay you every week.</p>
                        <p class="font-bold text-gray-700 mb-3">You'll learn:</p>
                        <ul class="space-y-2 mb-6">
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">The difference between freight brokering and dispatching</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to get licensed as a broker or work as an independent dispatcher</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to find carriers, shippers, and loads online</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to negotiate rates and build business relationships</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to use load boards, contracts, and dispatch tools effectively</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to start your own company or find job opportunities</span></li>
                        </ul>
