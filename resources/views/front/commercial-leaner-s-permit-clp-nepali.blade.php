            ...
            <div class="row align-items-center">
                <div class="col-md-8 text-white">
                    <h1 class="mb-4" style="font-size: 2.5rem; font-weight: bold;  color:var(--accent-color)  ;">
                        {{ $course->title }}</h1>
                    <p class="lead mb-4">
                        {{ $course->short_description ?? 'Unlock your trucking career with our full CDL permit prep course — available in both Nepali and English, with video, audio, and eBook lessons.' }}
                    </p>
                            ...
                            <li class="list-group-item d-flex   align-items-start">
                                <div class="ms-2">
                                    ...
                                    <p class="text-muted mb-0">Original price $297, now only $80.
                                        ...
                                        Video course, Audio course, Downloadable eBook, Covers all topics: General Knowledge, Air Brakes, Combination, Hazmat (H), Tanker (N), Doubles & Triples (T), Passenger (P), School Bus (S), Tanker + Hazmat (X).
                                    </p>
                                </div>
                            </li>
                            <li class="list-group-item d-flex   align-items-start">
