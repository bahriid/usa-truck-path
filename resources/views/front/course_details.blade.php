            ...
            <div class="container" style="position: relative; z-index: 1;">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-md-end button-section">
                        @guest
                            {{-- <a href="{{ route('register.with.course') }}" class="cta-btn">Login to Enroll</a> --}}
                            ...
                            <div class="row g-4  align-items-center">
                                <div class="col-md-6 p-4 d-flex flex-column justify-content-between about-back">
                                    <div>
                                        ...
                                        <h2 class="card-title mb-3 fw-bold text-success">Everything You Need to Pass Your CDL Permit Test
                                        </h2>
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="text-muted small">Study in English, Arabic, Somali, Amharic, French, or Nepali — clear support for all students.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <h5 class="fw-semibold mb-2">Real DMV Questions and Answers</h5>
                                <p class="text-muted small">Practice with the real test format and actual DMV questions from every U.S. state.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="text-muted small">Access videos, eBooks, and audio lessons — perfect for every learning style.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="text-muted small">Pass on your first try — or get extended access for free.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            <div class="card-body text-center p-4">
                                ...
                                <p class="text-muted small">Study anytime, anywhere — whether you’re working full-time or balancing a busy life..</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
        ...
        <section class="why-info bg-light py-5">
                        ...
                        <ul class="list-group list-group-numbered">
                            <li class="list-group-item d-flex   align-items-start">
                                <div class="ms-2">
                                    ...
                                    <p class="text-muted mb-0">Original price $297, now only $47.
         ...
         <section id="testimonials" class="testimonials section">
            ...
            <div class="container section-title" data-aos="fade-up">
                ...
                <p>Read inspiring stories from individuals who have successfully
