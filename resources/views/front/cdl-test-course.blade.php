                ...
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 mb-6">
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to form your LLC, EIN, and business bank account</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to apply for USDOT, MC Authority, BOC-3, UCR, IRP, and IFTA</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to choose the best insurance and drug consortium (C/TPA)</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to buy the best truck - new or used - and what to inspect</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to find loads, work with dispatchers, and connect with direct shippers</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to stay compliant with ELD, maintenance, and safety records</span></li>
                        </ul>
            ...
            <div class="max-w-6xl mx-auto">
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 text-lg leading-relaxed mb-6">This course and mentorship program walks you through everything you need to start your own trucking company in the U.S. You'll learn how to open your LLC, get USDOT and MC numbers, choose the best insurance, and buy the right truck. You'll also join our private Telegram group for lifetime guidance and daily business support.</p>
                        @guest
