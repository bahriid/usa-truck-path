                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden">
                        <details class="group">
                            <summary class="flex items-center justify-between p-4 cursor-pointer hover:bg-gray-50 transition-colors list-none">
                                ...
                                <i data-lucide="chevron-down" class="h-5 w-5 text-gray-400 transition-transform group-open:rotate-180"></i>
                            </summary>
                                    ...
                                    <ul class="divide-y divide-gray-100">
                                        @foreach ($chapter->topics as $topic)
                                            <li class="p-4 flex items-center justify-between">
                                                ...
                                                @php $hasAccess = auth()->user() && auth()->user()->hasApprovedCourse($course->id); @endphp
                                                @if ($hasAccess)
                                                    <a href="{{ route('course.curriculam', ['course' => $course->id]) }}" class="text-[#1B75F0] hover:text-[#0A2342] font-bold text-sm">Access Content</a>
                                                @else
            ...
            <div class="max-w-5xl mx-auto bg-gray-50 rounded-2xl p-8">
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mb-4">Moving from Canada to the U.S. to drive a truck can be life-changing - but the process can also be confusing. This course and mentorship program simplifies every step, making it easy for Canadian drivers to start their U.S. trucking journey with confidence.</p>
                        <p class="font-bold text-gray-700 mb-3">You'll learn:</p>
                        <ul class="space-y-2 mb-6">
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to qualify and apply for the right work visa or cross-border permits</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to convert your Canadian Class 1 license to a U.S. CDL</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to find trusted U.S. trucking companies hiring Canadian drivers</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">What documents you need: passport, medical card, background checks, and insurance</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to prepare for your move - housing, taxes, and pay expectations</span></li>
                            <li class="flex items-start gap-2"><i data-lucide="check-circle" class="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0"></i><span class="text-gray-600">How to avoid mistakes that delay your approval or job offer</span></li>
                        </ul>
                        <p class="text-gray-600 mb-6">After joining, you'll get access to our private Telegram mentorship group, where you'll receive personal guidance, job leads, and daily support from our mentors.</p>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all hover:-translate-y-1">
                    <div class="w-14 h-14 bg-[#1B75F0]/10 text-[#1B75F0] rounded-full flex items-center justify-center mb-4"><i data-lucide="languages" class="h-7 w-7"></i></div>
                ...
                <div class="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all hover:-translate-y-1">
                    <div class="w-14 h-14 bg-green-100 text-green-600 rounded-full flex items-center justify-center mb-4"><i data-lucide="message-square" class="h-7 w-7"></i></div>
                ...
                <div class="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all hover:-translate-y-1">
                    <div class="w-14 h-14 bg-[#F5B82E]/20 text-[#F5B82E] rounded-full flex items-center justify-center mb-4"><i data-lucide="play-circle" class="h-7 w-7"></i></div>
                ...
                <div class="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all hover:-translate-y-1">
                    <div class="w-14 h-14 bg-red-100 text-red-500 rounded-full flex items-center justify-center mb-4"><i data-lucide="shield-check" class="h-7 w-7"></i></div>
                ...
                <div class="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all hover:-translate-y-1">
                    <div class="w-14 h-14 bg-cyan-100 text-cyan-500 rounded-full flex items-center justify-center mb-4"><i data-lucide="award" class="h-7 w-7"></i></div>
                ...
                <div class="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all hover:-translate-y-1">
                    <div class="w-14 h-14 bg-gray-200 text-gray-600 rounded-full flex items-center justify-center mb-4"><i data-lucide="truck" class="h-7 w-7"></i></div>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto text-center">
                ...
                <p class="text-gray-600 text-lg">We make it easy to pass your Commercial Learner's Permit (CLP) test. Our all-in-one course includes video lessons, audio guides, and an eBook - available in multiple languages. It's everything you need to get started in trucking.</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-[#0A2342] text-white">
        <div class="container mx-auto px-4 text-center">
            <div class="max-w-3xl mx-auto">
                <h2 class="font-heading text-3xl font-bold text-[#F5B82E] uppercase mb-4">Ready to start your trucking career in the U.S.?</h2>
                <p class="text-gray-300 text-lg mb-6">Join today - learn how to transition from Canada to the U.S. trucking industry with lifetime mentorship and step-by-step support.</p>
                <p class="text-gray-300 mb-8">Enroll now and let us help you start driving in the U.S.</p>
                @guest
