                        ...
                        <div class="col">
                            <div class="card border-0 shadow-sm rounded-4 h-100">
                                <div class="card-body text-center p-4">
                                    ...
                                    <p class="text-muted small">Access video classes, eBooks, and audio lessons for a rich
                                        and
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-slide card border-0 shadow-sm rounded-4 p-4 h-100">
                                    ...
                                    <p class="text-muted mb-3">"I’m originally from Honduras and live in Columbus, Ohio. I
                                        ...
                                        for
                                        me. Then I found PassYourPermit.com, and it changed everything! The questions were
                                        just
                                        like the real test, and the lessons were easy to understand. I passed my permit test
                                        on
